...
rpm -ivh https://raw.github.com/letall/ovml/master/epel-release-6-8.noarch.rpm
else
rpm -ivh https://raw.github.com/letall/ovml/master/32-epel-release-6-8.noarch.rpm
fi
fi
...
cd /etc/
rm -rf ./sysctl.conf
wget https://raw.github.com/letall/ovml/master/sysctl.conf
sleep 3
...
wget https://raw.github.com/letall/ovml/master/zproxy.sh
chmod +x zproxy.sh
#cd /etc/squid/
#cp ./squid.conf ./squid.conf.bak
#wget https://raw.github.com/letall/ovml/master/squid.conf
